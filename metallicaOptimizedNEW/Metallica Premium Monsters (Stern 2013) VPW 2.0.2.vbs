...
Dim SSF_Gain : SSF_Gain = 0.5
Dim VolumeDial : VolumeDial = 0.8 * SSF_Gain           	' Overall Mechanical sound effect volume. Recommended values should be no greater than 1.
...
Dim ReflectOpt : ReflectOpt = 0					' 0 - Disabled, 1 - Enabled
...
Sub Table_OptionEvent(ByVal eventId)
	...
	ReflectOpt = Table.Option("Playfield Reflections", 0, 2, 1, 0, 0, Array("NONE", "BALL AND STATIC", "BALL AND DYNAMIC"))
    ...
    ' Sound volumes
    VolumeDial = Table.Option("Mech Volume", 0, 1, 0.01, 0.8, 1) * SSF_Gain
